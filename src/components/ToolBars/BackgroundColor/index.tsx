...
class BackgroundColor extends React.Component<any, any> {
    ...
    handleBackgroundColor = () => {
        ...
        if (quill.getSelection()) {
            ...
            quill.formatText(index, length, { background: '#ffcc33' })
        }
    }
}
