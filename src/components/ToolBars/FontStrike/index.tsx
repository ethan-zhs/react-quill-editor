...
class FontStrike extends React.Component<any, any> {
    ...
    handleStrike = () => {
        ...
        if (quill.getSelection()) {
            ...
            // 判断当前格式是否有删除线, 对文字设置删除线或取消删除线
            quill.formatText(index, length, { strike: !format.strike })
        }
    }
}
